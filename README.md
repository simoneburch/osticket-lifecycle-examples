...
*PLEASE NOTE: The websites that are still being referred to throughout this demo have since been torn down and are now pointing to non-existent spaces on the internet. If you've followed along in the installation and configuration of osTicket then you will see the up-and-running sites for yourself. These are screenshots taken during the exercise. :)
